...
// NOTE: This is not annotated as @Service, because I will return it as a bean
public class AutoBGUserDetailsService implements UserDetailsService {

    private final UserRepository userRepository;

    public AutoBGUserDetailsService(UserRepository userRepository) {
